...
/// Default idle timeout for mid-stream SSE reads (5 minutes).
///
/// Long enough to survive legitimate model thinking pauses, short enough
/// to detect half-open connections and stalled upstreams.
